...
# in your directory ./
btide: src/btide.c src/debug/debug.c src/config.c src/peer.c src/package.c src/bpkg.c src/utils/queue.c src/utils/str.c src/tree/merkletree.c src/crypt/sha256.c
	$(CC) $^ $(INCLUDE) $(CFLAGS) $(LDFLAGS) -o $@
